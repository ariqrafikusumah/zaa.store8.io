...
function Category() {
    ...
    const handleUpdate = (item) => {
        ...
        setSub_category(item.sub_category);
                                ...
                                <table className="table-auto border-collapse">
                                    <thead className="bg-gray-50">
                                        <tr className="bg-gray-200 text-gray-700">
                                            ...
                                            <th className="py-2 px-4 border">Sub Kategori</th>
                                            ...
                                            return (
                                                <>
                                                    <tr key={item}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap border">
                                                            <div className="text-sm font-medium text-gray-900">{item.sub_category}</div>
                                                        </td>
                                                        <td className="px-6 py-4 whitespace-nowrap border">
...
function EditData(props) {
    ...
    const [sub_category, setSub_category] = useState(props.sub_category || "");
    ...
    useEffect(() => {
        setSub_category(props.sub_category || "");
    }, [props.sub_category]);
                ...
                >
                    ...
                    <Modal.Body>
                        ...
                        <FloatingLabel
                            ...
                            className="mb-3"
                        >
                            <FormControl type="text" value={sub_category} onChange={handleDataChange2} placeholder='Sub Category' />
                        </FloatingLabel>
                        ...
                        <FloatingLabel
                            ...
                            className="mb-3"
                        >
                            <FormControl type="text" as="textarea" style={{ height: '100px' }} value={description} onChange={handleDataChange3} placeholder='Description' />
                        </FloatingLabel>
                        ...
                        <FloatingLabel
                            ...
                            className="mb-3"
                        >
                            <FormControl type="url" value={link} onChange={handleDataChange4} placeholder='URL gambar (https://example.com/)' readOnly disabled/>
                        </FloatingLabel>
                        ...
                        <FloatingLabel
                            ...
                            className="mb-3"
                        >
                            <FormControl type="url" value={petunjuk} onChange={handleDataChange5} placeholder='Petunjuk' />
                        </FloatingLabel>
                        ...
                        <FloatingLabel
                            ...
                            className="mb-3"
                        >
                            <FormControl type="url" value={thumbnail} onChange={handleDataChange6} placeholder='Thumbnail' />
                        </FloatingLabel>
                    </Modal.Body>
                    <Modal.Footer>
