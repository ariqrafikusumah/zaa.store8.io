...
export default function MobileLegend_1() {
                                            ...
                                            <>
                                                <div className='mt-3'>
                                                    <div key={item}>
                                                        ...
                                                        <label htmlFor={item.qris_name} className='inline-flex peer-checked:shadow-xl items-center justify-between w-full p-2 text-gray-500 border peer-checked:ring-blue-500 peer-checked:ring-2 border-gray-200 rounded-lg cursor-pointer peer-checked:text-gray-900 peer-checked:bg-blue-100 hover:text-gray-900 hover:bg-gray-100'>
                                                            <div className='block'>
