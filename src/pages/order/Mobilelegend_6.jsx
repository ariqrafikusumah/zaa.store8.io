...
export default function MobileLegend_6() {
                                        ...
                                        {dataPaymentWallet.map((item) => (
                                            <>
                                                <div className='mt-3'>
                                                    <div key={item}>
                                                        <input type="radio" className='hidden peer' name='payment' id={item.wallet_name} value={item.number_account} required />
                                                        <label htmlFor={item.wallet_name} className="inline-flex peer-checked:shadow-xl items-center justify-between w-full p-2 text-gray-500 border peer-checked:ring-blue-500 peer-checked:ring-4 border-gray-200 rounded-lg cursor-pointer peer-checked:text-gray-900 peer-checked:bg-blue-100 hover:text-gray-900 hover:bg-gray-100">
                                                            <div className='block'>
                                                                <div className='w-full text-sm font-semibold'>{item.wallet_name}</div>
                                                                <div className='w-full text-sm italic'>A/n {item.first_name} {item.last_name}</div>
                                                            </div>
